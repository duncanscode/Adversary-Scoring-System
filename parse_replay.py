...
from zephyrus_sc2_parser.exceptions import GameLengthNotFoundError
...
def replay_parser(filepath, my_username):
    ...
    except GameLengthNotFoundError:
        print("Looks like your opponent insta-left. Or we messed up. Either way, there's no data to analyze!")
